...
ALTER TABLE NL_active_emp ADD CONSTRAINT NL_active_emp_NL_member_FK FOREIGN KEY ( NL_member_member_id ) REFERENCES NL_member ( member_id ) ;

ALTER TABLE NL_file ADD CONSTRAINT NL_file_NL_active_emp_FK FOREIGN KEY ( NL_active_emp_employee_id ) REFERENCES NL_active_emp ( employee_id ) ;

ALTER TABLE NL_list ADD CONSTRAINT NL_list_NL_active_emp_FK FOREIGN KEY ( NL_active_emp_employee_id ) REFERENCES NL_active_emp ( employee_id ) ;

ALTER TABLE NL_list ADD CONSTRAINT NL_list_NL_member_FK FOREIGN KEY ( NL_member_member_id ) REFERENCES NL_member ( member_id ) ;

ALTER TABLE NL_member ADD CONSTRAINT NL_member_NL_active_emp_FK FOREIGN KEY ( NL_active_emp_employee_id ) REFERENCES NL_active_emp ( employee_id ) ;

ALTER TABLE NL_member ADD CONSTRAINT NL_member_NL_list_FK FOREIGN KEY ( NL_list_list_seq_id ) REFERENCES NL_list ( list_seq_id ) ;

ALTER TABLE NL_membership ADD CONSTRAINT NL_membership_NL_list_FK FOREIGN KEY ( NL_list_list_seq_id ) REFERENCES NL_list ( list_seq_id ) ;
